"""
A document to keep track of names used in src files.

VAR NAMES
resource:   list, dict, or string representing echo nest data
rtype:      type of echo nest data (artists, song, profile, etc)
